        ...
        <div className="grid sm:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 bg-gradient-to-br from-blue-600 to-blue-700 rounded-lg flex items-center justify-center shadow-md shadow-blue-500/20">
                <svg
            ...
            <p className="text-sm leading-relaxed text-gray-500">
              Software de gestión para gimnasios. Automatizá tu negocio y
              enfocate en lo que más importa.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3 mt-5">
              {[
                {
                  label: "Instagram",
                  href: "https://instagram.com/mazdesarrolloweb",
                  icon: (
                    <svg
                      className="w-4 h-4"
                      fill="currentColor"
